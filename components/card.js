    ...
    <section id="FEACHER" className="bg-white dark:bg-gray-900">
      <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
        <div className="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
          ...
          >
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris consequat gravida turpis, a rutrum enim tempor sed.
          </p>
        </div>
        <div
          data-aos="fade-up"
        ...
        >
          <div className="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
            ...
            <div className="flex items-baseline justify-center my-8">
              <span className="mr-2 text-5xl font-extrabold">Lorem ipsum</span>
            </div>
            ...
            <ul role="list" className="mb-8 space-y-4 text-left">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>
                Lorem ipsum <span className="font-semibold">Lorem ipsum</span>
                </span>
              </li>
              <li className="flex items-center space-x-3">
                <svg
